...
GOOGLE_AI_STUDIO_BASE = "https://generativelanguage.googleapis.com/v1beta"
IMAGE_TIMEOUT = 90
...
class MediaGateway:
    ...
    async def generate_image(
        ...
        """Generate image via Google AI Studio generateContent API.
        ...
        url = f"{GOOGLE_AI_STUDIO_BASE}/models/{profile.model}:generateContent"
